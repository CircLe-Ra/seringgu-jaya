...
<!-- Breadcrumb -->
<nav class="{{ $actions != null ? 'py-3' : 'py-[18.8px]' }} mt-16 sm:mt-12 flex justify-between px-5 text-gray-700 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                ...
                <li class="inline-flex items-center">
                    <a wire:navigate href="{{ $crumb['href'] }}" class="inline-flex items-center text-base font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                        @if($crumb['text'] == 'Dashboard')
                            <svg class="-mt-[2px] w-4 h-4 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
