        ...
        @foreach ($crumbs as $crumb)
            @if (isset($crumb['href']))
                <li class="inline-flex items-center">
                    <a wire:navigate href="{{ $crumb['href'] }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
            ...
            @else
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="text-sm font-medium text-gray-700 ms-1 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ $crumb['text'] }}</a>
                    </div>
                </li>
            @endif
        @endforeach
