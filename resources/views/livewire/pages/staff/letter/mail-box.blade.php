        ...
        <x-slot name="content">
            <div x-data="{ show : @entangle('edit') }" class="mt-3">
                <x-ui.alert x-show="show"
                         ...
                         color="warning" value="Sebelum mengunggah file, diharapkan untuk memeriksa kembali file yang akan diunggah guna meminimalkan kemungkinan kesalahan. Perlu diketahui, file yang sudah diunggah tidak dapat diubah." />
            </div>
                            ...
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-nowrap">
                                    @if($letter->status == 'apply')
                                        <x-ui.button size="xs" color="blue" wire:click="process({{ $letter->id }})">
                                            <svg class="w-3 h-3 me-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
