...
use function Livewire\Volt\{computed, state, layout, usesPagination, on, mount, updated};
                        ...
                        @foreach($this->familyCards as $key => $familyCard)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-nowrap">
                                    <x-ui.button tag="link" size="xs" color="yellow" href="#">
                                        <span class="iconify carbon--user w-3 h-3 me-1"></span>
                                        Anggota
                                    </x-ui.button>
                                    <x-ui.button size="xs" color="blue" wire:click="edit({{ $familyCard->id }})" wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:target="edit({{ $familyCard->id }})">
                                        <span class="iconify carbon--edit w-3 h-3 me-1"></span>
                                        Ubah
                                    </x-ui.button>
                                    <x-ui.button size="xs" color="red" wire:click="destroy({{ $familyCard->id }})"
