...
use App\Notifications\NotificationLetter;
use App\Events\LetterApply;
...
<div>
    ...
    <x-ui.modal id="upload-letter-modal">
        ...
        <x-slot name="footer">
            ...
            <x-ui.button size="sm" loading-only title="Simpan" submit color="blue" wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:target="store" wire:click="store" />
        </x-slot>
    </x-ui.modal>
            ...
            <x-ui.card class="mt-2 w-full ">
                ...
                <x-slot name="sideHeader">
                    <div class="flex gap-2 lg:justify-end items-center justify-center">
                        ...
                        <x-ui.button wire:navigate tag="link" href="{{ route('neighborhood-association.trash-letter') }}" size="xs" color="red" class="sm:flex-auto xl:flex-none">
                        ...
                        <x-ui.button wire:click="$dispatch('open-modal', { id: 'upload-letter-modal' })" size="xs" color="blue" class="sm:flex-auto xl:flex-none">
                            ...
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    @if($letter->letter_file != null)
                                        <a href="/storage/{{ $letter->letter_file }}" target="_blank" class="underline text-grey-200 hover:text-white">
                                            <svg class="w-10 h-10 object-cover" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                                <path fill="currentColor" fill-rule="evenodd" d="M14 22h-4c-3.771 0-5.657 0-6.828-1.172S2 17.771 2 14v-4c0-3.771 0-5.657 1.172-6.828S6.239 2 10.03 2c.606 0 1.091 0 1.5.017q-.02.12-.02.244l-.01 2.834c0 1.097 0 2.067.105 2.848c.114.847.375 1.694 1.067 2.386c.69.69 1.538.952 2.385 1.066c.781.105 1.751.105 2.848.105h4.052c.043.534.043 1.19.043 2.063V14c0 3.771 0 5.657-1.172 6.828S17.771 22 14 22" clip-rule="evenodd" opacity="0.45" />
                                ...
                                <td class="px-6 py-4">
                                    @if($letter->family_card_file != null)
                                        <a href="/storage/{{ $letter->family_card_file }}" target="_blank" class="underline text-grey-200 hover:text-white">
                                            <svg class="w-10 h-10 object-cover"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                ...
                                <td class="px-6 py-4">
                                    @if($letter->resident_identification_card_file != null)
                                        <a href="/storage/{{ $letter->resident_identification_card_file }}" target="_blank" class="underline text-grey-200 hover:text-white">
                                            <svg class="w-10 h-10 object-cover"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                                <path fill="currentColor" d="M19.999 4h-16c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2m-13.5 3a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3m5.5 10h-7l4-5l1.5 2l3-4l5.5 7z" />
                                            </svg>
                                        </a>
                                ...
                                <td class="px-6 py-4">
                                    @if($letter->response_letter_file != null)
                                        <a href="/storage/{{ $letter->response_letter_file }}" target="_blank" class="underline text-grey-200 hover:text-white">
                                            <svg class="w-10 h-10 object-cover"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                                <path fill="currentColor" d="M19.999 4h-16c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2m-13.5 3a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3m5.5 10h-7l4-5l1.5 2l3-4l5.5 7z" />
                                            </svg>
                                        </a>
                                ...
                                <td class="px-6 py-4 text-nowrap">
                                    <x-ui.button size="xs" color="blue" wire:loading.class="opacity-50 cursor-not-allowed" wire:click="apply({{ $letter->id }})" wire:confirm="Ajukan surat sekarang? Setelah tindakan ini disetujui, anda tidak akan bisa melakukan perubahan atau menghapus surat ini!" :disabled="$letter->submission_status">
                                        <slot:icon>
                                            <svg class="w-3 h-3 me-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16">
                                                <g fill="currentColor">
                                    ...
                                    <x-ui.button size="xs" color="yellow" wire:click="editData({{ $letter->id }})" :disabled="$letter->submission_status">
                                        <span class="iconify carbon--edit w-3 h-3 me-1"></span>
                                        Ubah
                                    </x-ui.button>
                                    <x-ui.button size="xs" color="red" wire:click="destroy({{ $letter->id }})" wire:confirm="Anda yakin ingin menghapus data ini?" :disabled="$letter->submission_status">
